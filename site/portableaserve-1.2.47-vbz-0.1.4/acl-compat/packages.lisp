...
(defpackage :acl-compat.excl
  ...
  (:export
   ...
   #+(or allegro cmu sbcl scl mcl lispworks) #:string-to-octets
   #+sbcl #:octets-to-string
   #+(or allegro cmu sbcl scl mcl lispworks) #:write-vector
   ))
...
#+sb-unicode
(defpackage #:llefu-sbcl
  (:use #:common-lisp)
  (:export
   #:get-ef
   #:variable-length-ef-p
   #:ascii-compatible-ef-p
   #:code->ef-mapper
   #:ef->code-mapper
   #:bytes-per-char-ef
   #:ef-code-length
...
(defpackage :gray-stream
  (:use #:common-lisp #+sbcl #:sb-ext #+sb-unicode #:llefu-sbcl)
