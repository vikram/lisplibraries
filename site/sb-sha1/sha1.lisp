...
(defun f1 (x y z)
  ...
  #-cmu
  (ldb (byte 32 0) (logior (logand x y) (logandc1 x z))))
...
(defun sha1sum-sequence (sequence &key (start 0) end)
  "Calculate the SHA1 message-digest of data in sequence.  On CMU CL and
SBCL this works for all sequences whose element-type is supported by the
