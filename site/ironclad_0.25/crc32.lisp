...
#32@(#x00000000 #x77073096 #xEE0E612C #x990951BA #x076DC419 #x706AF48F
...
(defclass crc32 ()
  ((crc :accessor crc32-crc :initform #xffffffff :type (unsigned-byte 32))))
...
(defmethod copy-digest ((state crc32))
  (let ((copy (make-instance 'crc32)))
...
(defdigest crc32 :digest-length 4)
