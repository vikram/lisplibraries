...
(defclass crc24 ()
  ((crc :accessor crc24-crc :initform #xb704ce :type (unsigned-byte 32))))
...
(defmethod copy-digest ((state crc24))
  (let ((copy (make-instance 'crc24)))
...
(defdigest crc24 :digest-length 3)
