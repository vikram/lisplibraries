...
be used to read the data from the stream."))
...
(defun massage-symbol (symbol)
  (let ((package (symbol-package symbol)))
    (cond
      ((eq package (find-package :ironclad)) symbol)
...
;;; If we pass a constant argument to MAKE-DIGEST, convert it to a
;;; direct call to the optimized MAKE-INSTANCE function.
