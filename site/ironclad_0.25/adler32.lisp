...
(defclass adler32 ()
  ((s1 :accessor adler32-s1 :initform 1 :type fixnum)
   (s2 :accessor adler32-s2 :initform 0 :type fixnum)))
...
(defmethod copy-digest ((state adler32))
  (let ((copy (make-instance 'adler32)))
    (setf (adler32-s1 copy) (adler32-s1 state)
          (adler32-s2 copy) (adler32-s2 state))
    copy))
