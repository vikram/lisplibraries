...
(DEFPACKAGE "COM.INFORMATIMAGO.COMMON-LISP.HEAP"
  (:USE "COMMON-LISP"
        "COM.INFORMATIMAGO.COMMON-LISP.MEMORY")
  (:IMPORT-FROM "COM.INFORMATIMAGO.COMMON-LISP.UTILITY" "WSIOSBP" "DEFENUM")
  ...
  (:DOCUMENTATION
   "
      ...
      2 of the License, or (at your option) any later version.
     "))
(IN-PACKAGE "COM.INFORMATIMAGO.COMMON-LISP.HEAP")
...
;;(declaim (inline gc-store gc-load)) ; not used in clisp, unfortunately.
            ...
            ((cvm-symbol-p cvm-value) 
             (or (ld-get cvm-value)
                 (let  ((lsym (ld-put cvm-value (cfi-make-symbol cvm-value))))
                   ;; PERHAPS we don't want to copy the value of a random symbol
                   #+(or)(cfi-symbol-copy-from-common lsym cvm-value)
                   lsym)))
...
(defcommon *test* :test "A test common variable")
(setf *test* (com.informatimago.common-lisp.list:iota 1000))
