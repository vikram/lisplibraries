...
(ASDF:DEFSYSTEM :COM.INFORMATIMAGO.COMMON-LISP :DESCRIPTION
                ...
                :VERSION "1.1.304" :AUTHOR "none" :LICENCE "NIL" :DEPENDS-ON
                NIL :COMPONENTS
                ((:PJB-CL-SOURCE-FILE "package")
                 (:PJB-CL-SOURCE-FILE "source-form" :DEPENDS-ON ("package"))
                 (:PJB-CL-SOURCE-FILE "reader" :DEPENDS-ON
                  ("package" "source-form"))
                 (:PJB-CL-SOURCE-FILE "source-text" :DEPENDS-ON
                  ("package" "reader"))
                 (:PJB-CL-SOURCE-FILE "utility" :DEPENDS-ON
                  ("package" "source-form"))
                 (:PJB-CL-SOURCE-FILE "ascii" :DEPENDS-ON ("package"))
                 (:PJB-CL-SOURCE-FILE "ecma048" :DEPENDS-ON
                  ("package" "utility"))
                 (:PJB-CL-SOURCE-FILE "list" :DEPENDS-ON ("package"))
                 (:PJB-CL-SOURCE-FILE "dll" :DEPENDS-ON ("package"))
                 (:PJB-CL-SOURCE-FILE "queue" :DEPENDS-ON
                  ("package" "utility"))
                 (:PJB-CL-SOURCE-FILE "array" :DEPENDS-ON ("package"))
                 (:PJB-CL-SOURCE-FILE "string" :DEPENDS-ON
                  ("package" "ecma048" "list" "utility"))
                 (:PJB-CL-SOURCE-FILE "stream" :DEPENDS-ON
                  ("package" "string"))
                 (:PJB-CL-SOURCE-FILE "file" :DEPENDS-ON
                  ("package" "ascii" "stream"))
                 (:PJB-CL-SOURCE-FILE "peek-stream" :DEPENDS-ON ("package"))
                 (:PJB-CL-SOURCE-FILE "scanner" :DEPENDS-ON
                  ("package" "ecma048" "utility"))
                 (:PJB-CL-SOURCE-FILE "parser" :DEPENDS-ON
                 ...
                 (:PJB-CL-SOURCE-FILE "brelation" :DEPENDS-ON
                  ("package" "bset" "utility"))
                 (:PJB-CL-SOURCE-FILE "graf" :DEPENDS-ON
                  ("package" "utility" "list"))
                 (:PJB-CL-SOURCE-FILE "graph" :DEPENDS-ON
                  ("package" "list" "utility"))
                 (:PJB-CL-SOURCE-FILE "graph-dot" :DEPENDS-ON
                  ("package" "graph" "string" "list"))
                 (:PJB-CL-SOURCE-FILE "graph-diagram" :DEPENDS-ON
                  ("package" "graph" "list"))
                 (:PJB-CL-SOURCE-FILE "combination" :DEPENDS-ON ("package"))
                 (:PJB-CL-SOURCE-FILE "pmatch" :DEPENDS-ON
                  ("package" "utility"))
                 (:PJB-CL-SOURCE-FILE "picture" :DEPENDS-ON
                  ("package" "utility" "string"))
                 (:PJB-CL-SOURCE-FILE "memory" :DEPENDS-ON ("package"))
                 (:PJB-CL-SOURCE-FILE "heap" :DEPENDS-ON
                  ("package" "memory" "utility"))
                 (:PJB-CL-SOURCE-FILE "activity" :DEPENDS-ON ("package"))
                 (:PJB-CL-SOURCE-FILE "message-queue" :DEPENDS-ON
                  ("package" "queue"))
                 (:PJB-CL-SOURCE-FILE "float-binio" :DEPENDS-ON ("package"))
                 (:PJB-CL-SOURCE-FILE "data-encoding" :DEPENDS-ON
                  ("package" "utility"))
                 (:PJB-CL-SOURCE-FILE "cons-to-ascii" :DEPENDS-ON
                  ("package" "picture" "string"))
                 (:PJB-CL-SOURCE-FILE "tree-to-ascii" :DEPENDS-ON
                  ("package" "picture"))
                 (:PJB-CL-SOURCE-FILE "tree-to-diagram" :DEPENDS-ON
                  ("package" "list"))
                 (:PJB-CL-SOURCE-FILE "regexp-posix" :DEPENDS-ON
                  ("package" "utility"))
                 (:PJB-CL-SOURCE-FILE "regexp-emacs" :DEPENDS-ON
                  ("package" "tree-to-ascii" "string"))
                 (:PJB-CL-SOURCE-FILE "rfc2822" :DEPENDS-ON
                  ("package" "ecma048"))
                 (:PJB-CL-SOURCE-FILE "rfc3548" :DEPENDS-ON
                  ("package" "stream"))
                 ...
                 (:PJB-CL-SOURCE-FILE "parse-html" :DEPENDS-ON
                  ("package" "html-iso8879-1" "peek-stream" "utility" "list"
                   "string"))
                 ...
                 (:PJB-CL-SOURCE-FILE "passwd" :DEPENDS-ON
                  ("package" "stream" "string"))
                 (:PJB-CL-SOURCE-FILE "group" :DEPENDS-ON
                  ("package" "stream" "string"))
                 (:PJB-CL-SOURCE-FILE "primes" :DEPENDS-ON
                  ("package" "utility"))
                 ...
                 (:PJB-CL-SOURCE-FILE "make-depends" :DEPENDS-ON
                  ("package" "html" "string" "character-sets" "list" "utility"
                   "file"))
                 ...
                 (:PJB-CL-SOURCE-FILE "browser" :DEPENDS-ON
                  ("package" "string"))
