...
(ASDF:DEFSYSTEM :COM.INFORMATIMAGO.CLEXT :DESCRIPTION
                "This ASDF system gathers all the COM.INFORMATIMAGO.CLEXT packages."
                :VERSION "1.0.169" :AUTHOR "none" :LICENCE "GPL" :DEPENDS-ON
                NIL :COMPONENTS ((:PJB-CL-SOURCE-FILE "closer-weak"))) 
