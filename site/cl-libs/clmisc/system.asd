...
(ASDF:DEFSYSTEM :COM.INFORMATIMAGO.CLMISC :DESCRIPTION
                "This ASDF system gathers all the COM.INFORMATIMAGO.CLMISC packages."
                :VERSION "1.0.177" :AUTHOR "none" :LICENCE "GPL" :DEPENDS-ON
                NIL :COMPONENTS ((:PJB-CL-SOURCE-FILE "resource-utilization"))) 
